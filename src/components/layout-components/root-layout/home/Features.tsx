...
export default function Features() {
  return (
    <section className="container mx-auto my-10">
      <main className="flex justify-between border">
        <div className=" my-10 w-full space-y-[170px] border">
          <div>
            <div className="w-full ">
              <div className="max-w-[53ch] mx-auto">
                <ImageCompo />
              </div>
            </div>
          </div>
          <div className="w-full flex relative justify-center items-center ">
            <div className=" absolute top-2/5 -right-7 z-[9]  w-[48px] flex justify-center items-center  p-3  bg-[#2A9DF4] rounded-full ">
              <figure className="">
                <Image width={28} height={28} src={"/assets/Home/searchicon.png"} alt="criket" />
              </figure>
            </div>
            <div className="w-full ">
              <div className="max-w-[53ch] mx-auto">
        ...
        <div className="w-[4px] relative bg-[#2A9DF4]">
        ...
        <div className="my-10 w-full space-y-[170px] border border-sky-600">
          <div className=" w-full flex relative justify-center items-center ">
            <div className=" absolute top-2/5 -left-7 z-[8]  w-[48px] flex justify-center items-center  p-3  bg-[#2A9DF4] rounded-full ">
              <figure className="">
                <Image width={28} height={28} src={"/assets/Home/searchicon.png"} alt="criket" />
              </figure>
            </div>
